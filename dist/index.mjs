...
import { mainnet, optimism, optimismSepolia, arbitrum, avalanche, polygon, bsc, base, baseSepolia, sepolia, blast, blastSepolia, avalancheFuji, degen, cyberTestnet, kaia, cyber, ham, zora } from 'viem/chains';
