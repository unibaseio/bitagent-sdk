...
import { getMintClubContractAddress, SdkSupportedChainIds, TokenType, Version } from '../constants/contracts';
...
export function computeCreate2Address(chainId: number, tokenType: TokenType, tokenSymbol: string, version: Version) {
  const bondAddress = getMintClubContractAddress('BOND', chainId as SdkSupportedChainIds, version);
